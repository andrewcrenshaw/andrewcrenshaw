...
**[Lexenne: *Remember*](https://remember.lexenne.com)** - Persistent memory architecture for agents (the memory layer to Create's harness): a metabolic knowledge graph where institutional knowledge compounds across sessions through assumption registers, decision-quality tracking, and drift detection. Runs standalone as a durable memory layer for any agent stack.
